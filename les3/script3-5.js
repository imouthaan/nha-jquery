...
const groterKleiner = (response_1 > response_2)? 'Het eerste getal is groter ' : (response_1 === response_2) ? 'De getallen zijn gelijk aan elkaar'  : 'Het eerste getal is kleiner' ; 

document.getElementById('divResult').innerHTML = resultaat;

document.getElementById('groterKleiner').innerHTML = groterKleiner;