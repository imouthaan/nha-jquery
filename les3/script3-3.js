...
const vergelijken= (response_1 > response_2)?'Het eerste getal is groter ': 'Het tweede getal is groter';
...
document.getElementById('divUitkomst').innerHTML = vergelijken;